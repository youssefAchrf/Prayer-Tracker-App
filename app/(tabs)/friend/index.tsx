...
import { router } from 'expo-router';
import { Plus, User as UserIcon, Mail, Check, X, Eye, EyeOff, ChevronRight, Trash2 } from 'lucide-react-native';
import { useSupabaseUser } from '@/contexts/SupabaseUserContext';

// --- CUSTOM MODAL COMPONENT (Web-Friendly) ---
const CustomConfirmationModal = ({ visible, title, message, onCancel, onConfirm }) => {
  if (!visible) {
    return null;
  }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <CustomConfirmationModal
        visible={isModalVisible}
        title="Remove Friend"
        message={`Are you sure you want to remove ${friendToRemove?.name}? This action cannot be undone.`}
...
const styles = StyleSheet.create({
  ...
  // --- STYLES FOR THE CUSTOM MODAL ---
  modalOverlay: {
    // This makes the modal cover the entire screen and appear on top
